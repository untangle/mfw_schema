...
#   timestamp: 2025-09-15T14:31:15+00:00
#   version:   0.25.2
...
class Neighbor(BaseModel):
    ...
    update_source: Annotated[
        str | None,
        Field(default=None, description="The source IP address for BGP updates"),
    ]
    keepalive: Annotated[
        int | None, Field(default=60, description="The BGP keepalive timer in seconds")
    ]
    hold: Annotated[int | None, Field(default=180, description="The BGP hold timer in seconds")]
...
class BgpItem(BaseModel):
    ...
    vrf: Annotated[
        str | None,
        Field(default="default", description="The VRF to use for this BGP instance"),
    ]
    local_asn: Annotated[
        int,
    ...
    graceful_restart: Annotated[
        bool | None, Field(default=False, description="Enable BGP graceful restart")
    ]
    advertised_networks: Annotated[
        Sequence[str] | None,
        Field(default=None, description="A list of networks to advertise"),
    ]
    address_family: Annotated[AddressFamily, Field(description="BGP address family configuration")]
    neighbor: Annotated[Neighbor, Field(description="BGP neighbor configuration")]
...
class DhcpOption(BaseModel):
    ...
    description: Annotated[
        str | None,
        Field(default=None, description="Admin-supplied human readable description"),
    ]
...
class FileSettings(BaseModel):
    ...
    path: Annotated[
        str | None,
        Field(default=None, description="The path of the file, not used in some cases"),
    ]
    operation: Annotated[
        str | None,
        Field(
...
class WireguardPeer(BaseModel):
    ...
    host: Annotated[
        str | None,
        Field(default=None, description="The wireguard server's IP or hostname"),
    ]
    port: Annotated[int | None, Field(default=None, description="The wireguard server's port")]
    presharedKey: Annotated[
        str | None,
        Field(default=None, description="The wireguard peer's pre-shared key"),
    ]
    keepalive: Annotated[
        int | None,
        Field(
...
class Logging(BaseModel):
    ...
    type: Annotated[str | None, Field(default=None, description="Type of log file")]
    file: Annotated[str | None, Field(default=None, description="Path to log file")]
    size: Annotated[int | None, Field(default=None, description="Size of log file in Kib")]
    remote: Annotated[bool | None, Field(default=None, description="Is log file located remotely")]
    ip: Annotated[str | None, Field(default=None, description="IP of remote log")]
    port: Annotated[int | None, Field(default=None, description="Port of remote log")]
    protocol: Annotated[
        str | None,
        Field(default=None, description="Protocol for remote logging (either tcp/udp)"),
    ]
    prefix: Annotated[str | None, Field(default=None, description="Logging Prefix")]
...
class SetupWizardSettings(BaseModel):
    ...
    completed: Annotated[
        bool | None,
        Field(default=None, description="True if the setup wizard has been completed"),
    ]
    lastStep: Annotated[
        str | None,
        Field(
...
class TimeZoneSettings(BaseModel):
    ...
    displayName: Annotated[
        str | None,
        Field(default=None, description="The display name of the timezone (in the UI)"),
    ]
    value: Annotated[
        str | None,
        Field(default=None, description="The actual value of the timezone (used by OS)"),
    ]
...
class CloudSettings(BaseModel):
    ...
    enabled: Annotated[bool | None, Field(default=None, description="Enable cloud connection")]
    supportAccessEnabled: Annotated[
        bool | None,
        Field(default=None, description="Enable remote support team access"),
    ]
    cloudServers: Annotated[
        Sequence[str] | None, Field(default=None, description="Remote cloud servers")
    ]
...
class AutoSettings(BaseModel):
    ...
    enabled: Annotated[bool | None, Field(default=None, description="Enable auto schedule")]
    dayOfWeek: Annotated[
        int | None,
        Field(
            default=None,
...
class ReportRendering(BaseModel):
    ...
    type: Annotated[Type3 | None, Field(default=None, description="The chart type")]
    units: Annotated[str | None, Field(default=None, description="The units of the report")]
    colors: Annotated[Sequence[str] | None, Field(default=None, description="The color palette")]
    stacking: Annotated[
        Stacking | None,
        Field(
            default=None,
    ...
    dashStyle: Annotated[
        DashStyle | None,
        Field(default=None, description="The line/area charts line dashing style"),
    ]
    dataGroupingEnabled: Annotated[
        bool | None,
        Field(default=None, description="True to enable data grouping for Time Series"),
    ]
    dataGroupingApproximation: Annotated[
        DataGroupingApproximation | None,
        Field(default=None, description="The approximation method for data grouping"),
    ]
    ...
    textString: Annotated[
        str | None,
        Field(default=None, description="The user-defined string for a text report"),
    ]
...
class RuleAction(BaseModel):
    ...
    priority: Annotated[int | None, Field(default=None, ge=1, le=21)]
...
class Rule(BaseModel):
    ...
    enabled: Annotated[
        bool | None,
        Field(default=None, description="True if rule is enabled, False otherwise"),
    ]
    description: Annotated[str | None, Field(default=None, description="The human description")]
    conditions: (
        Sequence[
            RuleCondition3
            | RuleCondition4
    ...
    readOnly: Annotated[
        bool | None,
        Field(default=None, description="True if read only, False otherwise"),
    ]
...
class Chain(BaseModel):
    ...
    hook: Annotated[
        Hook | None,
        Field(default=None, description="The netfilter hook, only applies to base chains"),
    ]
    priority: Annotated[
        int | None,
        Field(
    ...
    base: Annotated[
        bool | None,
        Field(default=None, description="True if base chain, False otherwise"),
    ]
    editable: Annotated[
        bool | None,
        Field(default=None, description="True if chain is editable, False otherwise"),
    ]
    rules: Sequence[Rule]
...
class Table(BaseModel):
    ...
    chain_type: Annotated[
        ChainType | None,
        Field(default=None, description="The type of chains in this table"),
    ]
...
class AccountCredentials(BaseModel):
    ...
    username: Annotated[str | None, Field(default=None, description="The username")]
    email: Annotated[str | None, Field(default=None, description="This accounts email address")]
    authorizedKeys: Annotated[str | None, Field(default=None, description="SSH authorized keys")]
...
class WidgetSettings(BaseModel):
    ...
    name: Annotated[str | None, Field(default=None, description="The name of the report")]
    interval: Annotated[
        int | None, Field(default=None, description="The refresh interval (in seconds)")
    ]
...
class WanCriterion(BaseModel):
    ...
    attribute: Annotated[
        Attribute | None, Field(default=None, description="An interface attribute")
    ]
    ...
    metric: Annotated[Metric | None, Field(default=None, description="An interface metric")]
    metric_value: Annotated[
        int | None,
        Field(default=None, description="The value associated with the interface metric"),
    ]
    metric_op: MetricOp | None = None
    connectivityTestType: Annotated[
        ConnectivityTestType | None,
        Field(default=None, description="The type of connectivity test"),
    ]
    connectivityTestInterval: Annotated[
        int | None,
        Field(default=None, description="The connectivity test interval in seconds"),
    ]
    connectivityTestTimeout: Annotated[
        int | None,
        Field(default=None, description="The connectivity test timeout in seconds"),
    ]
    ...
    connectivityTestTarget: Annotated[
        str | None, Field(default=None, description="IP/host address to test")
    ]
...
class DiscoveryPluginSettings(BaseModel):
    ...
    type: Annotated[str | None, Field(default=None, description="The discovery collector type")]
    enabled: Annotated[
        bool | None,
        Field(default=None, description="Enable/Disable the individual collector"),
    ]
    autoInterval: Annotated[
        float | None,
        Field(default=None, description="The autoscan interval to run this collector on"),
    ]
...
class GeoipNetworkSettings(BaseModel):
    ...
    address: Annotated[
        str | None,
        Field(default=None, description="CIDR network to bypass from fencing"),
    ]
    description: Annotated[
        str | None, Field(default=None, description="Description of the network")
    ]
...
class Authentication(BaseModel):
    ...
    shared_secret: Annotated[
        str | None, Field(default=None, description="The shared secret value for auth")
    ]
    type: Annotated[
        str | None,
        Field(default=None, description="the type of authentication configured"),
    ]
...
class IpsecEncryption(BaseModel):
    ...
    encryption: Annotated[str | None, Field(default=None, description="The encryption type")]
    group: Annotated[
        str | None, Field(default=None, description="The encryption group information")
    ]
    hash: Annotated[str | None, Field(default=None, description="The hash type information")]
...
class NetworkDefinition(BaseModel):
    ...
    network: Annotated[str | None, Field(default=None, description="the network address")]
    prefix: Annotated[
        float | None, Field(default=None, description="The network CIDR prefix range")
    ]
...
class StaticRouteItem(BaseModel):
    ...
    enabled: Annotated[
        bool | None,
        Field(default=None, description="True if static route is enabled, false otherwise"),
    ]
    description: Annotated[
        str | None, Field(default=None, description="Description of the static route")
    ]
    interfaceId: Annotated[
        float | None,
        Field(default=None, description="The interface ID to link the static route with"),
    ]
    network: Annotated[
        str | None,
        Field(default=None, description="Static route network destination information"),
    ]
    nextHop: Annotated[
        str | None,
        Field(
    ...
    metric: Annotated[
        float | None,
        Field(default=None, description="Specifies the route metric to use"),
    ]
...
class ThreatpreventionBypassItem(BaseModel):
    ...
    host: Annotated[
        str | None,
        Field(default=None, description="CIDR network to bypass from threat prevention"),
    ]
    description: Annotated[
        str | None, Field(default=None, description="Description of the network")
    ]
...
class UriTranslations(BaseModel):
    ...
    uri: Annotated[str | None, Field(default=None, description="The URI to match for")]
    host: Annotated[
        str | None,
        Field(
            default=None,
...
class WebfilterCategories(BaseModel):
    ...
    flagged: Annotated[
        ...
        Field(
            default=None,
            description="True if web filter category is being flagged, false otherwise",
        ),
    ]
    id: Annotated[
        float | None,
        Field(default=None, description="Unique identifier of the web filter category"),
    ]
    logged: Annotated[
        bool | None,
        Field(
            default=None,
            description="True if web filter category is being reported, false otherwise",
        ),
    ]
...
class WebfilterListItem(BaseModel):
    ...
    description: Annotated[
        str | None, Field(default=None, description="Description of the list item")
    ]
    exact: Annotated[
        bool | None,
        Field(
    ...
    name: Annotated[str | None, Field(default=None, description="The list item value to match on")]
    logged: Annotated[
        bool | None,
        Field(
            default=None,
...
class PingAnalyzerSettings(BaseModel):
    ...
    name: Annotated[str | None, Field(default=None, description="Name of Ping Analyzer")]
    interfaceIds: Sequence[int] | None = None
    ipv4Addresses: Sequence[str] | None = None
    ipv6Addresses: Sequence[str] | None = None
    enabled: Annotated[
        bool | None, Field(default=None, description="Turns a Ping Analyzer on or off")
    ]
...
class DynamicListsConfiguration(BaseModel):
    ...
    name: Annotated[
        str | None,
        Field(default=None, description="Name of the block list from source"),
    ]
    id: Annotated[str | None, Field(default=None, description="ID of the block list from source")]
    source: Annotated[
        str | None,
        Field(default=None, description="The source URL or the local file path"),
    ]
    type: Annotated[
        str | None,
        Field(default=None, description="Either IP or URL block list type from source"),
    ]
...
class LoggerSetting(RootModel[Mapping[str, LoggerSetting1] | None]):
    root: Annotated[
        Mapping[str, LoggerSetting1] | None,
        Field(default=None, description="The logger settings for a package or function"),
    ] = None
...
class DatabaseConfigSettings(BaseModel):
    name: Annotated[
        str | None,
        Field(default=None, description="DB Connection name (this will be shown on UI)"),
    ]
    description: Annotated[
        str | None,
        Field(default=None, description="Additional description for the DB Connection"),
    ]
    id: Annotated[
        str | None,
        Field(default=None, description="UUID for Database (auto-generated)"),
    ]
    type: Annotated[
        Type35 | None,
        Field(default=None, description="Database type i.e. MySQL,postgres"),
    ]
    enabled: Annotated[
        bool | None,
        Field(default=None, description="Database Connection enabled/disabled"),
    ]
    db_server: Annotated[str | None, Field(default=None, description="Remote Host/Server")]
    db_name: Annotated[str | None, Field(default=None, description="Name of the Database.")]
    db_username: Annotated[
        str | None, Field(default=None, description="Username for the Database.")
    ]
    db_port: Annotated[int | None, Field(default=None, description="Database Port")]
    db_password: Annotated[
        str | None,
        Field(default=None, description="Database password for the given user."),
    ]
    db_connection_string: Annotated[
        str | None, Field(default=None, description="Connection String")
    ]
    default: Annotated[
        bool | None,
        Field(default=None, description="Flag which determines if the database is default"),
    ]
...
class IpsRule(BaseModel):
    ...
    enabled: Annotated[bool | None, Field(default=None, description="Enable/Disable the IPS rule")]
    sid: Annotated[
        int | None,
        Field(default=None, description="The unique identifier for the IPS rule"),
    ]
    action: Annotated[
        Action7 | None,
        Field(default=None, description="Action to take when the rule matches"),
    ]
    message: Annotated[
        str | None,
        Field(default=None, description="Message to log when the rule matches (optional)"),
    ]
    classType: Annotated[
        str | None,
        Field(default=None, description="Class type of the IPS rule (optional)"),
    ]
...
class IpsRuleList(BaseModel):
    ...
    name: Annotated[str | None, Field(default=None, description="Name of the IPS rule list")]
    url: Annotated[
        str | None,
        Field(default=None, description="URL to fetch the IPS rule list from"),
    ]
    enabled: Annotated[
        bool | None, Field(default=None, description="Enable/Disable the IPS rule list")
    ]
    local_dir: Annotated[
        str | None,
        Field(
    ...
    version: Annotated[
        str | None,
        Field(default=None, description="Version of the IPS rule list (optional)"),
    ]
...
class InterfaceSettings(BaseModel):
    ...
    v4ConfigType: Annotated[
        V4ConfigType | None,
        Field(default=None, description="The IPv4 configuration type"),
    ]
    v4StaticAddress: Annotated[
        IPv4Address | None, Field(default=None, description="The IPv4 static address")
    ]
    v4StaticPrefix: Annotated[
        int | None,
        Field(default=None, description="The IPv4 static prefix (netmask)", ge=1, le=32),
    ]
    v4StaticGateway: Annotated[
        IPv4Address | None, Field(default=None, description="The IPv4 static gateway")
    ]
    v4StaticDNS1: Annotated[IPv4Address | None, Field(default=None, description="The IPv4 DNS 1")]
    v4StaticDNS2: Annotated[IPv4Address | None, Field(default=None, description="The IPv4 DNS 2")]
    v4DhcpAddressOverride: Annotated[
        IPv4Address | None, Field(default=None, description="The DHCP address override")
    ]
    v4DhcpPrefixOverride: Annotated[
        int | None,
        Field(default=None, description="The DHCP prefix override", ge=1, le=32),
    ]
    v4DhcpGatewayOverride: Annotated[
        IPv4Address | None, Field(default=None, description="The DHCP gateway override")
    ]
    v4DhcpDNS1Override: Annotated[
        IPv4Address | None, Field(default=None, description="The DHCP DNS 1 override")
    ]
    v4DhcpDNS2Override: Annotated[
        IPv4Address | None, Field(default=None, description="The DHCP DNS 2 override")
    ]
    v4PPPoEUsername: Annotated[
        str | None, Field(default=None, description="The PPPoE username", min_length=1)
    ]
    v4PPPoEPassword: Annotated[
        str | None, Field(default=None, description="The PPPoE password", min_length=1)
    ]
    v4PPPoEUsePeerDNS: Annotated[
        bool | None, Field(default=None, description="If true, use PPPoE peer DNS")
    ]
    v4PPPoEOverrideDNS1: Annotated[
        IPv4Address | None, Field(default=None, description="The PPPoE DNS 1 override")
    ]
    v4PPPoEOverrideDNS2: Annotated[
        IPv4Address | None, Field(default=None, description="The PPPoE DNS 2 override")
    ]
    v4Aliases: Annotated[
        Sequence[Ipv4Alias] | None,
        Field(default=None, description="IPv4 address aliases"),
    ]
    v6ConfigType: Annotated[
        V6ConfigType | None, Field(default=None, description="IPv6 configuration type")
    ]
    v6StaticAddress: Annotated[
        IPv6Address | None, Field(default=None, description="The IPv6 static address")
    ]
    v6StaticPrefix: Annotated[
        int | None,
        Field(default=None, description="The IPv6 static prefix", ge=1, le=128),
    ]
    v6StaticGateway: Annotated[
        IPv6Address | None, Field(default=None, description="The IPv6 static gateway")
    ]
    v6StaticDNS1: Annotated[IPv6Address | None, Field(default=None, description="The IPv6 DNS 1")]
    v6StaticDNS2: Annotated[IPv6Address | None, Field(default=None, description="The IPv6 DNS 2")]
    v6DhcpDNS1Override: Annotated[
        IPv6Address | None, Field(default=None, description="The DHCP DNS 1 override")
    ]
    v6DhcpDNS2Override: Annotated[
        IPv6Address | None, Field(default=None, description="The DHCP DNS 2 override")
    ]
    v6AssignHint: Annotated[
        str | None, Field(default=None, description="The IPv6 auto assign hint")
    ]
    v6AssignPrefix: Annotated[
        int | None,
        Field(default=None, description="The IPv6 auto assign prefix", ge=1, le=128),
    ]
    v6Aliases: Annotated[
        Sequence[Ipv6Alias] | None,
        Field(default=None, description="IPv6 address aliases"),
    ]
    routerAdvertisements: Annotated[
        bool | None, Field(default=None, description="Send router advertisements")
    ]
    bridgedTo: Annotated[
        int | None,
        Field(
    ...
    qosEnabled: Annotated[bool | None, Field(default=None, description="Enable QoS")]
    ...
    macaddr: Annotated[
        str | None,
        Field(default=None, description="The MAC address to set for the interface"),
    ]
    dhcpEnabled: Annotated[
        bool | None,
        Field(default=None, description="If true, provide DHCP on this interface"),
    ]
    dhcpRangeStart: Annotated[
        IPv4Address | None,
        Field(default=None, description="The start of the DHCP offer range"),
    ]
    dhcpRangeEnd: Annotated[
        IPv4Address | None,
        Field(default=None, description="The end of the DHCP offer range"),
    ]
    dhcpLeaseDuration: Annotated[
        int | None,
        Field(default=None, description="The DHCP lease duration in seconds", ge=0),
    ]
    ...
    dhcpOptions: Annotated[
        Sequence[DhcpOption] | None, Field(default=None, description="DHCP Options")
    ]
    vrrpEnabled: Annotated[bool | None, Field(default=None, description="True if VRRP is enabled")]
    vrrpID: Annotated[int | None, Field(default=None, description="The VRRP ID", ge=1, le=255)]
    vrrpPriority: Annotated[
        int | None, Field(default=None, description="The VRRP priority", ge=1, le=255)
    ]
    vrrpV4Aliases: Annotated[
        Sequence[Ipv4Alias] | None,
        Field(default=None, description="VRRP IPv4 address aliases"),
    ]
    vrrpTrack: Annotated[
        Sequence[Track] | None,
        Field(default=None, description="VRRP Group Tracked Objects"),
    ]
    wirelessSsid: Annotated[str | None, Field(default=None, description="The wireless SSID")]
    wirelessEncryption: Annotated[
        WirelessEncryption | None,
        Field(default=None, description="The wireless encryption method"),
    ]
    wirelessMode: Annotated[
        WirelessMode | None,
        Field(default=None, description="The wireless mode (AP or client)"),
    ]
    wirelessPassword: Annotated[
        str | None, Field(default=None, description="The wireless password")
    ]
    wirelessChannel: Annotated[
        int | None, Field(default=None, description="The wireless channel", ge=0)
    ]
    wirelessThroughput: Annotated[
        str | None, Field(default=None, description="The wireless throughput mode")
    ]
    ...
    openvpnUsername: Annotated[
        ...
        Field(
            default=None,
            description="The openvpn username if username authentication enabled",
        ),
    ]
    ...
    wireguardPrivateKey: Annotated[
        str | None, Field(default=None, description="The wireguard private key")
    ]
    wireguardPublicKey: Annotated[
        str | None, Field(default=None, description="The wireguard public key")
    ]
    wireguardAddresses: Annotated[
        Sequence[WireguardAddress] | None,
        Field(default=None, description="List of WireGuard's interface IP addresses"),
    ]
    wireguardEditMode: Annotated[
        WireguardEditMode | None,
        Field(default=None, description="How this VPN is to be edited"),
    ]
    wireguardType: Annotated[
        WireguardType | None, Field(default=None, description="Type of of VPN")
    ]
    wireguardPort: Annotated[
        int | None,
        Field(default=None, description="The port that wireguard listens on"),
    ]
    wireguardPeers: Annotated[
        Sequence[WireguardPeer] | None,
        Field(default=None, description="List of wireguard peers"),
    ]
    simNetwork: Annotated[str | None, Field(default=None, description="Sim network name")]
    simApn: Annotated[str | None, Field(default=None, description="Modem access point name")]
    simProfile: Annotated[int | None, Field(default=None, description="Modem profile number")]
    simPin: Annotated[int | None, Field(default=None, description="Sim pin code")]
    simDelay: Annotated[
        int | None,
        Field(default=None, description="Delay before configuring the modem on boot"),
    ]
    ...
    simAuth: Annotated[
        SimAuth | None, Field(default=None, description="Sim authentication method")
    ]
    simUsername: Annotated[
        str | None, Field(default=None, description="Sim authentication username")
    ]
    simPassword: Annotated[
        str | None, Field(default=None, description="Sim authentication password")
    ]
    simMode: Annotated[SimMode | None, Field(default=None, description="Sim mode")]
    simPdptype: Annotated[
        SimPdptype | None, Field(default=None, description="Sim connection method")
    ]
    simPlmn: Annotated[
        int | None,
        Field(
    ...
    simAutoconnect: Annotated[
        bool | None,
        Field(default=None, description="Enable automatic connect/reconnect"),
    ]
    ethAutoneg: bool | None = None
    ethDuplex: Annotated[EthDuplex | None, Field(default=None, description="Duplex mode")]
    ethSpeed: Annotated[int | None, Field(default=None, description="Interface speed")]
    mtu: Annotated[int | None, Field(default=None, description="Interface MTU setting")]
    routeMtu: Annotated[
        bool | None,
        Field(default=None, description="Use Route MTU Discovery to determine MTU"),
    ]
    vlanid: Annotated[
        int | None,
        Field(
    ...
    virtual: Annotated[
        bool | None,
        Field(default=None, description="Virtual interface indicator (vlan/vpn/etc.)"),
    ]
    wanWeight: Annotated[
        float | None,
        Field(
            default=None,
            description="Weight of WAN interface to use in weighted balance algorithms",
        ),
    ]
...
class ReportCondition(BaseModel):
    ...
    column: Annotated[str | None, Field(default=None, description="The column to check the value")]
    operator: Annotated[Operator | None, Field(default=None, description="The sql operator")]
    value: Annotated[str | None, Field(default=None, description="The value to check")]
...
class FirewallSettings(BaseModel):
    ...
    tables: Annotated[
        Mapping[str, AccessTable]
        | Mapping[str, FilterTable]
        | Mapping[str, NatTable]
        | Mapping[str, Any]
        | Mapping[str, ShapingTable]
        | Mapping[str, Table]
        | None,
        Field(
            default=None,
...
class DhcpSettings(BaseModel):
    ...
    staticDhcpEntries: Annotated[
        ...
        Field(default=None, description="List of static DHCP assignments"),
    ]
...
class DnsSettings(BaseModel):
    ...
    localServers: Annotated[
        ...
        Field(default=None, description="List of local DNS servers"),
    ]
    staticEntries: Annotated[
        Sequence[StaticDnsEntry] | None,
        Field(default=None, description="List of static DNS assignments"),
    ]
...
class WanPolicy(BaseModel):
    ...
    enabled: Annotated[
        bool | None,
        Field(default=None, description="True if policy is enabled, False otherwise"),
    ]
    description: Annotated[str | None, Field(default=None, description="The human description")]
    type: Annotated[Type17, Field(description="The policy type")]
    best_of_metric: Annotated[
        BestOfMetric | None,
        Field(default=None, description="The metric used for best of policies"),
    ]
    ...
    balance_algorithm: Annotated[
        ...
        Field(default=None, description="Algorithm used for balance type policies"),
    ]
    criteria: Annotated[
        Sequence[WanCriterion] | None,
        Field(default=None, description="The list of policy interface criteria"),
    ]
    readOnly: Annotated[
        bool | None,
        Field(default=None, description="True if read only, False otherwise"),
...
class DiscoverySettings(BaseModel):
    ...
    enabled: Annotated[
        bool | None,
        Field(default=None, description="Enable/Disable the host device discovery tool"),
    ]
...
class GeoipSettings(BaseModel):
    ...
    enabled: Annotated[
        bool | None,
        Field(default=None, description="Enable/Disable the geoip fencing service"),
    ]
...
class ThreatpreventionSettings(BaseModel):
    ...
    enabled: Annotated[
        bool | None,
        Field(default=None, description="Enable/Disable the threat prevention service"),
    ]
    redirect: Annotated[
        bool | None,
        Field(default=None, description="Enable/Disable redirection to block page"),
    ]
...
class WebfilterSettings(BaseModel):
    ...
    enabled: Annotated[
        bool | None,
        Field(default=None, description="True if web filter is enabled, false otherwise"),
    ]
...
class DnsfilterSettings(BaseModel):
    ...
    enabled: Annotated[
        bool | None,
        Field(default=None, description="Enable/Disable the dns filter service"),
    ]
...
class IpsSettings(BaseModel):
    ...
    enabled: Annotated[bool | None, Field(default=None, description="Is plugin enabled")]
    enabled_ips: Annotated[bool | None, Field(default=None, description="Is IPS enabled")]
    rules: Annotated[
    ...
    ruleLists: Annotated[
        ...
        Field(default=None, description="List of IPS rule list sources"),
    ]
...
class ReportEntry(BaseModel):
    ...
    type: Annotated[Type1, Field(description="The type of report/chart")]
    database_table: Annotated[
        str | None, Field(default=None, description="The table the report queries")
    ]
    tables: Annotated[
        Sequence[str] | None,
        Field(
...
class IpsecServerSettings(BaseModel):
    ...
    debug: Annotated[
        float | None,
        Field(default=None, description="Enable/Disable ipsec server debug logs"),
    ]
    authentication: Annotated[
        Authentication | None,
        Field(default=None, description="authentication definition"),
    ]
...
class MfwSchema(BaseModel):
    ...
    databases: Annotated[
        ...
        Field(default=None, description="Database settings"),
    ]
    bypass: BypassSettings | None = None
    dns_filter: DnsfilterSettings | None = None
    alerts: Annotated[
        Sequence[AlertObject] | None,
        Field(default=None, description="alerts configuration"),
    ]
