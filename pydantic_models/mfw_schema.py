...
#   timestamp: 2025-09-15T13:58:08+00:00
#   version:   0.25.2
...
class Neighbor(BaseModel):
    ...
    hold: Annotated[
        int | None, Field(default=180, description="The BGP hold timer in seconds")
    ]
...
class BgpItem(BaseModel):
    ...
    address_family: Annotated[
        AddressFamily, Field(description="BGP address family configuration")
    ]
...
class FileSettings(BaseModel):
    ...
    path: Annotated[
        str | None,
        Field(
            default=None, description="The path of the file, not useds in some cases"
        ),
    ]
    operation: Annotated[
        str | None,
...
class WireguardPeer(BaseModel):
    ...
    port: Annotated[
        int | None, Field(default=None, description="The wireguard server's port")
    ]
...
class Logging(BaseModel):
    ...
    size: Annotated[
        int | None, Field(default=None, description="Size of log file in Kib")
    ]
    remote: Annotated[
        bool | None, Field(default=None, description="Is log file located remotely")
    ]
...
class TimeZoneSettings(BaseModel):
    ...
    value: Annotated[
        str | None,
        Field(
            default=None, description="The actual value of the timezone (used by OS)"
        ),
    ]
...
class CloudSettings(BaseModel):
    ...
    enabled: Annotated[
        bool | None, Field(default=None, description="Enable cloud connection")
    ]
...
class AutoSettings(BaseModel):
    ...
    enabled: Annotated[
        bool | None, Field(default=None, description="Enable auto schedule")
    ]
    dayOfWeek: Annotated[
        int | None,
        Field(
...
class ReportRendering(BaseModel):
    ...
    units: Annotated[
        str | None, Field(default=None, description="The units of the report")
    ]
    colors: Annotated[
        Sequence[str] | None, Field(default=None, description="The color pallette")
    ]
    stacking: Annotated[
        Stacking | None,
        Field(
...
class Rule(BaseModel):
    ...
    description: Annotated[
        str | None, Field(default=None, description="The human description")
    ]
    conditions: (
        Sequence[
            RuleCondition3
...
class Chain(BaseModel):
    ...
    hook: Annotated[
        Hook | None,
        Field(
            default=None, description="The netfilter hook, only applies to base chains"
        ),
    ]
    priority: Annotated[
        int | None,
...
class StaticDhcpEntry(BaseModel):
    """
    An IP address to be statically assinged to a specific device
    """
...
class AccountCredentials(BaseModel):
    ...
    email: Annotated[
        str | None, Field(default=None, description="This accounts email address")
    ]
    authorizedKeys: Annotated[
        str | None, Field(default=None, description="SSH authorized keys")
    ]
...
class WidgetSettings(BaseModel):
    ...
    name: Annotated[
        str | None, Field(default=None, description="The name of the report")
    ]
    interval: Annotated[
...
class WanCriterion(BaseModel):
    ...
    metric: Annotated[
        Metric | None, Field(default=None, description="An interface metric")
    ]
    metric_value: Annotated[
        int | None,
        Field(
            default=None, description="The value associated with the interface metric"
        ),
    ]
...
class DiscoveryPluginSettings(BaseModel):
    ...
    type: Annotated[
        str | None, Field(default=None, description="The discovery collector type")
    ]
    enabled: Annotated[
        bool | None,
    ...
    autoInterval: Annotated[
        float | None,
        Field(
            default=None, description="The autoscan interval to run this collector on"
        ),
    ]
...
class IpsecEncryption(BaseModel):
    ...
    encryption: Annotated[
        str | None, Field(default=None, description="The encryption type")
    ]
    group: Annotated[
        str | None, Field(default=None, description="The encryption group information")
    ]
    hash: Annotated[
        str | None, Field(default=None, description="The hash type information")
    ]
...
class NetworkDefinition(BaseModel):
    ...
    network: Annotated[
        str | None, Field(default=None, description="the network address")
    ]
    prefix: Annotated[
...
class StaticRouteItem(BaseModel):
    ...
    enabled: Annotated[
        bool | None,
        Field(
            default=None, description="True if static route is enabled, false otherwise"
        ),
    ]
    description: Annotated[
    ...
    interfaceId: Annotated[
        float | None,
        Field(
            default=None, description="The interface ID to link the static route with"
        ),
    ]
    network: Annotated[
        str | None,
...
class ThreatpreventionBypassItem(BaseModel):
    """
    threatprevention bypassed network object
    """
    ...
    host: Annotated[
        str | None,
        Field(
            default=None, description="CIDR network to bypass from threat prevention"
        ),
    ]
    description: Annotated[
        str | None, Field(default=None, description="Description of the network")
...
class WebfilterCategories(BaseModel):
    ...
    id: Annotated[
        float | None,
        Field(default=None, description="Unique identifier of the webfilter category"),
    ]
    logged: Annotated[
        bool | None,
        Field(
...
class WebfilterListItem(BaseModel):
    """
    webfilter list items for block/pass list entries
    """
    ...
    name: Annotated[
        str | None, Field(default=None, description="The list item value to match on")
    ]
    logged: Annotated[
        bool | None,
        Field(
...
class PingAnalyzerSettings(BaseModel):
    ...
    name: Annotated[
        str | None, Field(default=None, description="Name of Ping Analyzer")
    ]
...
class DynamicListsConfiguration(BaseModel):
    ...
    id: Annotated[
        str | None, Field(default=None, description="ID of the block list from source")
    ]
    source: Annotated[
        str | None,
...
class LoggerSetting(RootModel[Mapping[str, LoggerSetting1] | None]):
    root: Annotated[
        ...
        Field(
            default=None, description="The logger settings for a package or function"
        ),
    ] = None
...
class DatabaseConfigSettings(BaseModel):
    name: Annotated[
        str | None,
        Field(
            default=None, description="DB Connection name (this will be shown on UI)"
        ),
    ]
    description: Annotated[
        str | None,
    ...
    db_server: Annotated[
        str | None, Field(default=None, description="Remote Host/Server")
    ]
    db_name: Annotated[
        str | None, Field(default=None, description="Name of the Database.")
    ]
    ...
    default: Annotated[
        bool | None,
        Field(
            default=None, description="Flag which determines if the database is default"
        ),
    ]
...
class IpsRule(BaseModel):
    ...
    enabled: Annotated[
        bool | None, Field(default=None, description="Enable/Disable the IPS rule")
    ]
    sid: Annotated[
        int | None,
    ...
    message: Annotated[
        str | None,
        Field(
            default=None, description="Message to log when the rule matches (optional)"
        ),
    ]
    classType: Annotated[
        str | None,
...
class IpsRuleList(BaseModel):
    ...
    name: Annotated[
        str | None, Field(default=None, description="Name of the IPS rule list")
    ]
    url: Annotated[
        str | None,
...
class SwitchSettings(BaseModel):
    ...
    vlans: Annotated[
        Sequence[SwitchVlan], Field(description="Hardware based vlans of the switch")
    ]
...
class InterfaceSettings(BaseModel):
    ...
    name: Annotated[
        str, Field(description="Human readable name", max_length=15, min_length=1)
    ]
    enabled: Annotated[
        bool | None,
        Field(
    ...
    v4StaticPrefix: Annotated[
        int | None,
        Field(
            default=None, description="The IPv4 static prefix (netmask)", ge=1, le=32
        ),
    ]
    v4StaticGateway: Annotated[
        IPv4Address | None, Field(default=None, description="The IPv4 static gateway")
    ]
    v4StaticDNS1: Annotated[
        IPv4Address | None, Field(default=None, description="The IPv4 DNS 1")
    ]
    v4StaticDNS2: Annotated[
        IPv4Address | None, Field(default=None, description="The IPv4 DNS 2")
    ]
    ...
    v6StaticDNS1: Annotated[
        IPv6Address | None, Field(default=None, description="The IPv6 DNS 1")
    ]
    v6StaticDNS2: Annotated[
        IPv6Address | None, Field(default=None, description="The IPv6 DNS 2")
    ]
    ...
    vrrpEnabled: Annotated[
        bool | None, Field(default=None, description="True if VRRP is enabled")
    ]
    vrrpID: Annotated[
        int | None, Field(default=None, description="The VRRP ID", ge=1, le=255)
    ]
    ...
    wirelessSsid: Annotated[
        str | None, Field(default=None, description="The wireless SSID")
    ]
    ...
    wireguardEditMode: Annotated[
        ...
        Field(default=None, description="How this VPN is to be editied"),
    ]
    ...
    simNetwork: Annotated[
        str | None, Field(default=None, description="Sim network name")
    ]
    simApn: Annotated[
        str | None, Field(default=None, description="Modem access point name")
    ]
    simProfile: Annotated[
        int | None, Field(default=None, description="Modem profile number")
    ]
    ...
    ethDuplex: Annotated[
        EthDuplex | None, Field(default=None, description="Duplex mode")
    ]
...
class ReportCondition(BaseModel):
    ...
    column: Annotated[
        str | None, Field(default=None, description="The column to check the value")
    ]
    operator: Annotated[
        Operator | None, Field(default=None, description="The sql operator")
    ]
...
class DhcpSettings(BaseModel):
    ...
    staticDhcpEntries: Annotated[
        ...
        Field(default=None, description="List of static DHCP assignements"),
    ]
...
class DnsSettings(BaseModel):
    ...
    staticEntries: Annotated[
        ...
        Field(default=None, description="List of static DNS assignements"),
    ]
...
class DiscoverySettings(BaseModel):
    ...
    enabled: Annotated[
        bool | None,
        Field(
            default=None, description="Enable/Disable the host device discovery tool"
        ),
    ]
...
class RouteSettings(RootModel[Sequence[StaticRouteItem]]):
    ...
    root: Annotated[
        Sequence[StaticRouteItem], Field(description="Static route entries")
    ]
...
class WebfilterSettings(BaseModel):
    ...
    enabled: Annotated[
        bool | None,
        Field(
            default=None, description="True if webfilter is enabled, false otherwise"
        ),
    ]
...
class IpsSettings(BaseModel):
    ...
    enabled: Annotated[
        bool | None, Field(default=None, description="Is plugin enabled")
    ]
    enabled_ips: Annotated[
        bool | None, Field(default=None, description="Is IPS enabled")
    ]
    rules: Annotated[
