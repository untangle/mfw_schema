...
#   timestamp: 2025-09-07T17:09:44+00:00
...
class Neighbor(BaseModel):
    ...
    update_source: Optional[str] = Field(
        None, description='The source IP address for BGP updates'
    )
    keepalive: Optional[int] = Field(
        60, description='The BGP keepalive timer in seconds'
    )
...
class BgpItem(BaseModel):
    vrf: Optional[str] = Field(
        'default', description='The VRF to use for this BGP instance'
    )
